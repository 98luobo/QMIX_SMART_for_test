...
class COMALearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        pi = mac_out.view(-1, self.n_actions)  # log
        baseline = (pi * q_vals).sum(-1).detach()  # V
    ...
    def _train_critic(self, batch, rewards, terminated, actions, avail_actions, mask, bs, max_t):
        ...
        for t in reversed(range(rewards.size(1))):  # reversed
            ...
            td_error = (q_taken - targets_t.detach())  # td-error: q-return
